...
```text
/plugin marketplace add tazabekov/claude-voice
/plugin install claude-voice-response@tazabekov
```

### From a local clone

```bash
git clone https://github.com/tazabekov/claude-voice.git
```

Then in Claude Code:

```text
/plugin marketplace add ./claude-voice
/plugin install claude-voice-response@tazabekov
```
